...
| --- | --- | ---: | ---: | ---: |
| Method time | `_loadPolyfill` | 19.199 | 16.343 | -2.856 |
| Method time | `_log` | 0.070 | 0.075 | +0.005 |
...
| Frame bytes | `recv:BridgeCall` | 15421.000 | 10962.000 | -4459.000 |
| Frame bytes | `send:Execute` | 1240830.000 | 1242211.000 | +1381.000 |
