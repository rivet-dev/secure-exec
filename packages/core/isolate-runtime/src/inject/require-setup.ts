...
// This file is executed inside the isolate runtime.
      ...
      function _requireFrom(moduleName, fromDir) {
        ...
        if (source === null || source === undefined) {
          ...
          // _loadFile wraps CJS files as ESM (for V8's native module system).
          // Strip the wrapper so CJS require() can use the raw source with its
          // own function(exports, require, module, __filename, __dirname) wrapper.
          if (typeof source === 'string' && source.includes('export default __cjs;')) {
            // Extract original source from ESM wrapper generated by wrapCJSForESMWithModulePath:
            //   const __filename = ...; ... let exports = module.exports;
            //   <ORIGINAL SOURCE>
            //   const __cjs = module.exports; export default __cjs; ...
