...
/**
 * Generates docs/os-test-conformance-report.mdx from test results and exclusion data.
 *
 * Usage: pnpm tsx scripts/generate-os-test-report.ts
 *   --input os-test-conformance-report.json
 *   --exclusions packages/wasmvm/test/os-test-exclusions.json
 *   --output docs/os-test-conformance-report.mdx
 */
...
const { values } = parseArgs({
  options: {
    input: { type: 'string', default: resolve(__dirname, '../os-test-conformance-report.json') },
    exclusions: { type: 'string', default: resolve(__dirname, '../packages/wasmvm/test/os-test-exclusions.json') },
    output: { type: 'string', default: resolve(__dirname, '../docs/os-test-conformance-report.mdx') },
  },
});
...
// Frontmatter
line('---');
line('title: os-test Conformance Report');
line('description: os-test POSIX.1-2024 conformance results for WasmVM.');
line('icon: "chart-bar"');
line('---');
line();
line('{/* AUTO-GENERATED — do not edit. Run scripts/generate-os-test-report.ts */}');
line();
...
console.log(`os-test Conformance Report generated`);
