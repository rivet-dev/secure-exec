...
globalThis._maxTimers = 10000;
globalThis._maxHandles = 10000;
globalThis.__runtimeBridgeSetupConfig = {"initialCwd":"/root","jsonPayloadLimitBytes":4194304,"payloadLimitErrorCode":"ERR_SANDBOX_PAYLOAD_TOO_LARGE"};
"use strict";
(() => {
...
(() => {
  ...
  __runtimeExposeMutableGlobal("_currentModule", { dirname: __initialCwd });
	      ...
	      const __consoleBudget = {"maxDepth":6,"maxKeys":50,"maxArrayLength":50,"maxOutputLength":4096};
	      const normalizeBudget = function normalizeBudget(budget) {
    const defaults = {
        maxDepth: 6,
        maxKeys: 50,
        maxArrayLength: 50,
    ...
    return {
        ...
        maxOutputLength: clamp(budget.maxOutputLength, defaults.maxOutputLength),
	      ...
	      const safeStringifyConsoleValueWithBudget = function safeStringifyConsoleValueWithBudget(value, budget) {
    ...
    try {
      ...
      const safeStringifyConsoleValue = function safeStringifyConsoleValue(value, rawBudget) {
    return safeStringifyConsoleValueWithBudget(value, normalizeBudget(rawBudget));
};
      const formatConsoleArgs = function formatConsoleArgs(args, rawBudget) {
...
var bridge = (() => {
  ...
  var Agent = class {
    ...
    _activeCounts = /* @__PURE__ */ new Map();
...
globalThis.__runtimeCustomGlobalPolicy = {"hardenedGlobals":["_processConfig","_osConfig","bridge","_registerHandle","_unregisterHandle","_waitForActiveHandles","_getActiveHandles","_childProcessDispatch","_childProcessModule","_osModule","_moduleModule","_httpModule","_httpsModule","_http2Module","_dnsModule","_httpServerDispatch","_httpServerUpgradeDispatch","_upgradeSocketData","_upgradeSocketEnd","ProcessExitError","_log","_error","_loadPolyfill","_resolveModule","_loadFile","_scheduleTimer","_cryptoRandomFill","_cryptoRandomUUID","_cryptoHashDigest","_cryptoHmacDigest","_cryptoPbkdf2","_cryptoScrypt","_cryptoCipheriv","_cryptoDecipheriv","_cryptoCipherivCreate","_cryptoCipherivUpdate","_cryptoCipherivFinal","_cryptoSign","_cryptoVerify","_cryptoGenerateKeyPairSync","_cryptoSubtle","_fsReadFile","_fsWriteFile","_fsReadFileBinary","_fsWriteFileBinary","_fsReadDir","_fsMkdir","_fsRmdir","_fsExists","_fsStat","_fsUnlink","_fsRename","_fsChmod","_fsChown","_fsLink","_fsSymlink","_fsReadlink","_fsLstat","_fsTruncate","_fsUtimes","_fs","_childProcessSpawnStart","_childProcessStdinWrite","_childProcessStdinClose","_childProcessKill","_childProcessSpawnSync","_networkFetchRaw","_networkDnsLookupRaw","_networkHttpRequestRaw","_networkHttpServerListenRaw","_networkHttpServerCloseRaw","_upgradeSocketWriteRaw","_upgradeSocketEndRaw","_upgradeSocketDestroyRaw","_ptySetRawMode","require","_requireFrom","_dynamicImport","__dynamicImport","_moduleCache","fetch","Headers","Request","Response","Blob"],"mutableGlobals":["_pendingModules","_currentModule","_stdinData","_stdinPosition","_stdinEnded","_stdinFlowMode","module","exports","__filename","__dirname"]};
"use strict";
(() => {
  // isolate-runtime/src/common/global-access.ts
